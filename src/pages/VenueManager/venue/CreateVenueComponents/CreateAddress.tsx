...
interface AddressVenueFormProps {
  formData: VenueFormData;
  handleInputChange: (e: React.ChangeEvent<HTMLInputElement>) => void; // Corrected type
  isEditing: boolean;
}

const CreateAddressVenueForm = ({ formData, handleInputChange, isEditing }: AddressVenueFormProps) => (
  <section className={`shadow-lg bg-white p-[2rem] dark:bg-gray-900 border-[1px] border-gray-300 dark:border-gray-700 rounded-3xl mb-4 grid md:grid-cols-2 gap-4 ${isEditing ? 'border-indigo-400 border-[1px] rounded-lg dark:border-indigo-400' : ''}`}>
    <div className="mb-4">
    ...
    <div className="mb-4">
      ...
      />
       ...
       <div className="mb-4">
      <label htmlFor="location" className="block mb-2 text-md font-medium text-gray-800 dark:text-white">Location:</label>
      <input
        type="text"
        id="location"
        name="location"
...
export default CreateAddressVenueForm;