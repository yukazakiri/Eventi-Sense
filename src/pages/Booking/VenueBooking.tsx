                ...
                <div className="noise-bg max-w-[90rem] mx-auto my-[2rem] md:my-[10rem] rounded-2xl shadow-lg">
                    <div className="grid md:grid-cols-2">
                        <div className='m-4'>
                            ...
                            <ul className="flex mt-4 bg-sky-100 rounded-full py-1 w-fit ">
                                {amenities.map((amenity) => (
                                    <li key={amenity.id} className="text-sky-700 px-2">
                                        {amenity.name} ,
                                    </li>
                                ))}
                            </ul>
                            <p className='bg-green-100 text-green-700 py-1 w-fit rounded-full px-2 my-4'>PHP {venue?.price}</p>
                        </div>
