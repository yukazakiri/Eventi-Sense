...
const CreateAddressSupplierForm = ({ formData, handleInputChange, isEditing }: AddressSupplierFormProps) => (
  <section className={`shadow-lg bg-white p-[2rem] border-gray-300 border-[1px] rounded-2xl dark:border-gray-700 dark:bg-gray-900 ${isEditing ? 'border-indigo-400 border-2 rounded-lg' : ''}`}>
    <div className="mb-4">
