    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#2F4157]">
                ...
                <motion.div 
                    className="relative h-[60vh] sm:h-[70vh] md:h-[70vh]"
                    initial="hidden"
                    animate="visible"
                    variants={fadeInUp}
                >
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      initial={{ rotate: 180 }}
                      animate={{ rotate: scrollY.get() > 50 ? 220 : 0 }}
                ...
                {/* Event Planners List Section with Stagger Animation */}
                <section className='bg-white'>
                    <motion.div 
                        className="mx-4 sm:mx-6 xl:mx-16 py-10 lg:border-r lg:border-b border-gray-600/20"
                        initial="hidden"
                        whileInView="visible"
