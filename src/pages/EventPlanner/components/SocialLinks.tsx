...
interface EventPlannerSocialMedia {
    id?: string;
...
function SocialMediaLinks() {
    const user = useUser();
    const [socialMedia, setSocialMedia] = useState<EventPlannerSocialMedia[]>([]);
    const [_loading, setLoading] = useState(true);
    const [_error, setError] = useState<string | null>(null);
    const [newSocialMedia, setNewSocialMedia] = useState<EventPlannerSocialMedia>({
        event_planner_id: '',
        platform: '',
        link: '',
    });
